...
user in an INI file next to IHaveNoTomatoesPortable.exe called IHaveNoTomatoesPortable.ini.
...
copy AppNamePortable.ini from this directory to IHaveNoTomatoesPortable.ini next to
IHaveNoTomatoesPortable.exe. The options in the INI file are as follows:
